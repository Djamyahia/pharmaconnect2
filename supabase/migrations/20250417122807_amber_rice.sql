/*
  # Fix promotion order email notifications

  1. Changes
    - Update notify_order_status function to handle promotions correctly
    - Get price from inventory for both regular and promotion orders
    - Calculate total amount based on actual price and quantity
...
-- Update the notify_order_status function to handle promotions correctly
